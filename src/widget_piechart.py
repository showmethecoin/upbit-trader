...
class PieWorker(QThread):
    ...
    def run(self):
        ...
        while self.alive:
            ...
            if remain[0] != 0:
                labels.append(remain[1] + " : " +
                              str(round(remain[0]/sum * 100)) + "%")
            ...
            self.canvas.axes2.legend(
                pie[0], labels, loc='center', labelcolor='white',  borderpad=1, fontsize=12)
