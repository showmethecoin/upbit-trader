...
"")
        ...
        self.toplabel_icon.setStyleSheet("background-image: url(styles/icons/16x16/cil-chart-line.png);\n"
...
"")
        ...
        self.horizontalLayout_2.addWidget(self.toplabel_icon)
...
"}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(utils.get_file_path('styles/icons/20x20/cil-window-minimize.png')), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon1.addPixmap(QtGui.QPixmap(utils.get_file_path('styles/icons/16x16/cil-window-maximize.png')), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(utils.get_file_path('styles/icons/20x20/cil-x.png')), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(utils.get_file_path("styles/icons/20x20/cil-home.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(utils.get_file_path("styles/icons/24x24/cil-user.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(utils.get_file_path("styles/icons/24x24/cil-settings.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "보유 코인"))
        item = self.tableWidget_2.item(0, 1)
        item.setText(_translate("MainWindow", "보유 수량"))
        item = self.tableWidget_2.item(0, 2)
        item.setText(_translate("MainWindow", "매수 평균가"))
        item = self.tableWidget_2.item(0, 3)
        item.setText(_translate("MainWindow", "매수 금액"))
        item = self.tableWidget_2.item(0, 4)
        item.setText(_translate("MainWindow", "평균 금액"))
        item = self.tableWidget_2.item(0, 5)
        item.setText(_translate("MainWindow", "평가 손익"))
