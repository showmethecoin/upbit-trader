...
class TradeWidget(QWidget):
    ...
    def changed_total(self):
        ...
        if self.ui.tabWidget.currentIndex() == 0:
            ...
            if idx == 0 and self.ui.buy_price_1.value() != 0.0:
                self.ui.buy_volume_1.setValue(
                    self.ui.buy_total_price_1.value() / self.ui.buy_price_1.value())
            # Reservation
            elif self.ui.buy_price_3.value() != 0.0:
                self.ui.buy_volume_3.setValue(
                    self.ui.buy_total_price_3.value() / self.ui.buy_price_3.value())
        ...
        # SELL
            ...
            if idx == 0 and self.ui.sell_price_1.value() != 0.0:
                self.ui.sell_volume_1.setValue(
                    self.ui.sell_total_price_1.value() / self.ui.sell_price_1.value())
            # Reservation
            elif self.ui.sell_price_3.value() != 0.0:
                self.ui.sell_volume_3.setValue(
                    self.ui.sell_total_price_3.value() / self.ui.sell_price_3.value())
    ...
    def set_total_price(self):
        ...
        if self.ui.tabWidget.currentIndex() == 0:
            ...
            # Designation
            if idx == 0:
                self.ui.buy_total_price_1.setValue(
                    self.ui.buy_price_1.value() * self.ui.buy_volume_1.value())
            # Reservation
            else:
                self.ui.buy_total_price_3.setValue(
                    self.ui.buy_price_3.value() * self.ui.buy_volume_3.value())
        ...
        # SELL
            ...
            # Designation
            if idx == 0:
                self.ui.sell_total_price_1.setValue(
                    self.ui.sell_price_1.value() * self.ui.sell_volume_1.value())
            # Reservation
            else:
                self.ui.sell_total_price_3.setValue(
                    self.ui.sell_price_3.value() * self.ui.sell_volume_3.value())
