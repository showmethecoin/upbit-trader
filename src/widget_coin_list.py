...
from PyQt5.QtWidgets import QHeaderView, QTableWidget, QTableWidgetItem, QWidget, QListWidget
    ...
    def run(self):
        while self.alive:
            ...
            for coin in static.chart.coins.values():
                ...
                cointradeprice.append(format(round(coin.get_trade_price(), 3), ","))
                coinchangerate.append(round(coin.get_signed_change_rate() * 100, 2))
...
class CoinlistWidget(QWidget):
    def __init__(self, parent = None):
        ...
        self.coinlist = [ ]
        for coin in static.chart.coins.values():
            self.coinlist.append(coin.code)
